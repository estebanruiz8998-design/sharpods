...
def dataset(record: dict[str, Any]) -> dict[str, Any]:
    ...
    stats = {
        ...
        "orders_unfilled": sum(1 for d in decisions if d["type"] == "order_unfilled"),
        "orders_cancelled": sum(1 for d in decisions if d["type"] == "order_cancelled"),
...
def write_xlsx(record: dict[str, Any], path: str | Path) -> None:
    ...
    rows: list[tuple[str, str, str]] = [
        ...
        ("Orders cancelled (premise)", '=COUNTIF(Bets!D:D,"order_cancelled")', "0"),
